<?php
$engines=$this->config->getEnginesList('cloud');
//print_r(ClonOS::$engines);exit;
...
*/
?>
<dialog id="bhyve-cloud" class="window-box">
	...
	<form class="win" method="post" id="bhyveCloudSettings" onsubmit="return false;">
